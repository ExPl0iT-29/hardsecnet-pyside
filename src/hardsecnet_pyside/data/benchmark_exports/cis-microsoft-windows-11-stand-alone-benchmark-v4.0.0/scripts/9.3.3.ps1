...
# Control: 9.3.3 - Ensure 'Windows Firewall: Public: Settings: Display a notification' is set to 'No'
...
$PropertyType = "DWord"
$DesiredValue = 1
$ExpectedDescription = "DisableNotifications = 1"
$SettingTitle = "9.3.3 - Ensure 'Windows Firewall: Public: Settings: Display a notification' is set to 'No'"
