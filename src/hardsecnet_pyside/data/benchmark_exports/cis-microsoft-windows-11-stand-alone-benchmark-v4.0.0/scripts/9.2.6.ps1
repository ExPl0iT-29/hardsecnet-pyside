...
# Control: 9.2.6 - Ensure 'Windows Firewall: Private: Logging: Log dropped packets' is set to 'Yes'
...
$PropertyType = "DWord"
$DesiredValue = 1
$ExpectedDescription = "LogDroppedPackets = 1"
$SettingTitle = "9.2.6 - Ensure 'Windows Firewall: Private: Logging: Log dropped packets' is set to 'Yes'"
