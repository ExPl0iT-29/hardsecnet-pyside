...
# Control: 9.3.1 - Ensure 'Windows Firewall: Public: Firewall state' is set to 'On (recommended)'
...
$SettingTitle = "9.3.1 - Ensure 'Windows Firewall: Public: Firewall state' is set to 'On (recommended)'"
