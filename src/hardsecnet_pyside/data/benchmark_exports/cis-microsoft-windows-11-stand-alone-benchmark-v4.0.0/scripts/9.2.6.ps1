...
# Control: 9.2.6 - Ensure 'Windows Firewall: Private: Logging: Name' is set to '%SystemRoot%\System32\logfiles\firewall\privatefw.log'
...
$SettingTitle = "9.2.6 - Ensure 'Windows Firewall: Private: Logging: Name' is set to '%SystemRoot%\System32\logfiles\firewall\privatefw.log'"
$ExpectedDescription = "LogFileName = %SystemRoot%\System32\logfiles\firewall\privatefw.log"
$DesiredValue = '%SystemRoot%\System32\logfiles\firewall\privatefw.log'
$RollbackValue = '%SystemRoot%\System32\logfiles\firewall\pfirewall.log'
