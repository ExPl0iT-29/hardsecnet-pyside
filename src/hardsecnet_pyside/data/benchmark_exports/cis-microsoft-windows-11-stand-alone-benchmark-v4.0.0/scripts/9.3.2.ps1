...
# Control: 9.3.2 - Ensure 'Windows Firewall: Public: Inbound connections' is set to 'Block (default)'
...
$SettingTitle = "9.3.2 - Ensure 'Windows Firewall: Public: Inbound connections' is set to 'Block (default)'"
