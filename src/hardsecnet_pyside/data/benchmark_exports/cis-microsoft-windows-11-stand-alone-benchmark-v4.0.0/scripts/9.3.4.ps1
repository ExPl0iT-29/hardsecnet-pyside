...
# Control: 9.3.4 - Ensure 'Windows Firewall: Public: Settings: Apply local firewall rules' is set to 'No'
...
$SettingTitle = "9.3.4 - Ensure 'Windows Firewall: Public: Settings: Apply local firewall rules' is set to 'No'"
