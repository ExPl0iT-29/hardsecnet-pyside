...
# Control: 9.3.9 - Ensure 'Windows Firewall: Public: Logging: Log successful connections' is set to 'Yes'
...
$SettingTitle = "9.3.9 - Ensure 'Windows Firewall: Public: Logging: Log successful connections' is set to 'Yes'"
