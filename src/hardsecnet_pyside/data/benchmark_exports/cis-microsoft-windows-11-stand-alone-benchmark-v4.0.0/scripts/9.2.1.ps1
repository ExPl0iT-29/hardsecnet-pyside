...
# Control: 9.2.1 - Ensure 'Windows Firewall: Private: Firewall state' is set to 'On (recommended)'
...
$PropertyType = "DWord"
$DesiredValue = 1
$ExpectedDescription = "EnableFirewall = 1"
$SettingTitle = "9.2.1 - Ensure 'Windows Firewall: Private: Firewall state' is set to 'On (recommended)'"
