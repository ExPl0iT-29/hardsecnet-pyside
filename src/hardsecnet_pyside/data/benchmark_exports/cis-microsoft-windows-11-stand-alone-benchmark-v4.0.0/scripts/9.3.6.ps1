...
$SettingTitle = "9.3.6 - Ensure 'Windows Firewall: Public: Logging: Name' is set to '%SystemRoot%\System32\logfiles\firewall\publicfw.log'"
$ExpectedDescription = "LogFileName = %SystemRoot%\System32\logfiles\firewall\publicfw.log"
