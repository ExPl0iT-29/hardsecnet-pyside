...
# Control: 9.2.7 - Ensure 'Windows Firewall: Private: Logging: Log successful connections' is set to 'Yes'
...
$PropertyType = "DWord"
$DesiredValue = 1
$ExpectedDescription = "LogSuccessfulConnections = 1"
$SettingTitle = "9.2.7 - Ensure 'Windows Firewall: Private: Logging: Log successful connections' is set to 'Yes'"
