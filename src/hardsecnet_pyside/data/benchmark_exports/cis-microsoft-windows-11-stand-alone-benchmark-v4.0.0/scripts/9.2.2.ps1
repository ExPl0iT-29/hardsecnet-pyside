...
# Control: 9.2.2 - Ensure 'Windows Firewall: Private: Inbound connections' is set to 'Block (default)'
...
$SettingTitle = "9.2.2 - Ensure 'Windows Firewall: Private: Inbound connections' is set to 'Block (default)'"
$ExpectedDescription = "DefaultInboundAction = Block"
$DesiredValue = "Block"
$RollbackValue = "Allow"
