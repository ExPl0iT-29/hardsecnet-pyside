...
# Control: 9.3.8 - Ensure 'Windows Firewall: Public: Logging: Log dropped packets' is set to 'Yes'
...
$SettingTitle = "9.3.8 - Ensure 'Windows Firewall: Public: Logging: Log dropped packets' is set to 'Yes'"
